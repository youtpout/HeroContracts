    ...
    ReentrancyGuardUpgradeable
{
    ...
    function _sellNft(
        ...
        // address 0 is when we directly mint token and sell it
        require(from == info.seller || from == address(0), "Invalid seller");
        orderCount++;
        ...
        ownedOrders[info.seller].push(orderCount);

        emit OrderAdded(orderCount, info.seller, orderInfo);
    }
